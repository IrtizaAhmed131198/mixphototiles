    ...
    <section class="contact-us-section">
        <div class="container">
            <div class="row align-items-end flex-column-reverse flex-md-row">
                <div class="col-md-7 col-12 mb-md-auto">
                ...
                <div class="col-md-5 col-12">
                    <div class="ms-auto ContactForm_contactFormWrp__4NjEW">
                        {{-- <form class="contact-form" id="contactForm" method="post" action="{{ route('contact.submit') }}">
                            ...
                            <div class="mb-4">
                                <input placeholder="Phone Number" maxlength="10" id="phoneInput"
                                    class="form-control @error('phone') is-invalid @enderror" type="tel" name="phone"
                                    value="{{ old('phone') }}">
                                @error('phone')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-4">
                                <textarea placeholder="Message" maxlength="255" name="message" id="messageInput"
