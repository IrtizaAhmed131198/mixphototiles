...
@section('content')
                    ...
                    <nav aria-label="breadcrumb" class="">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item text-decoration-none"><a
                                    href="{{ route('collections') }}">Collections</a></li>
                ...
                <div class="col-lg-7 col-md-7 col-12">
                    ...
                    <div class="swiper frame-layout-slider">
                        <div class="swiper-wrapper">
                                                ...
                                                <div class="clusterFrameWrp {{ $colorClass }} {{ $frameClass }}"
                                                    ...
                                                    <div class="frame-main-wrap">
                                                        <div class="frameborder">
                                                            <div
                                                                class="frameinner d-flex align-items-center justify-content-center">
                                                                @php
                                                                ...
                                                                <img src="{{ asset($image_path) }}"
                                                                    ...
                                                                    alt="Preview">
                                                                <img src="{{ asset($image_path) }}"
                                                                    id="preview-{{ $cluster->id }}-orignal"
                                                                    class="d-none orignal-image">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="frameborder">
                                                            <div
                                                                ...
                                                                <svg width="32" height="32"
                                                                    class="image-placeholder clusterAddBtn__Rreup"
                                                                    fill="currentColor" viewBox="0 0 16 16">
                                                                    <path stroke-width=".5" fill-rule="evenodd"
                                                                        stroke="currentColor"
                                                                        d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z">
                                                                    </path>
                                                                </svg>
                                                                <img src="" id="preview-{{ $cluster->id }}"
                                                                    class="image-preview d-none w-100 h-100 object-fit-cover"
                                                                    alt="Preview">
                                                                <img src=""
                                                                    id="preview-{{ $cluster->id }}-orignal"
                                                                    class="d-none orignal-image">
                            ...
                            <div class="swiper-slide">
                                <figure class="frameBackground">
                                    <img src="{{ asset($product->coordinates_image) }}" alt="Additional Image"
                                        width="100">
                                </figure>
                            </div>
                            {{-- @endforeach --}}
                    ...
                    <div class="parentRightAccordiance">
                                            ...
                                            <ul class="designToolPropertiesLists CustomizeOption select-color">
                                                ...
                                                @foreach ($custom_color as $key => $val)
                                                    ...
                                                    <li type="button"
                                                        ...
                                                        data-price="{{ $val->price }}"
                                                        data-color="{{ $val->name }}"
                                                        data-class="{{ $cssClassName }}-frame">
                                                        <figure class="PropertiesleftChild">
                                                            <img alt="drawer" width="72" height="72"
                                                                class="LeftSidebar" src="{{ asset($val->option_img) }}">
                                                        </figure>
                                                        <div class="PropertiesRightChild">
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <ul class="designToolPropertiesLists CustomizeOption select-frame">
                                                ...
                                                <li type="button" class="parentProperties frame-change active"
                                                    data-name="border" data-class="classic-image-width">
                                                    <figure class="PropertiesleftChild">
                                                        <img alt="drawer" width="72" height="72"
                                                            class="LeftSidebar"
                                                            src="{{ asset('assets/images/1704186592728.png') }}">
                                                ...
                                                <li type="button" class="parentProperties frame-change"
                                                    data-name="noborder" data-class="bold-image-width">
                                                    <figure class="PropertiesleftChild">
                                                        <img alt="drawer" width="72" height="72"
                                                            class="LeftSidebar"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <ul class="designToolPropertiesLists CustomizeOption select-led">
                                                    ...
                                                    @foreach ($led as $key => $val)
                                                        ...
                                                        @endphp
                                                        <li type="button"
                                                            class="parentProperties led-change {{ $key == 0 ? 'active' : '' }}"
                                                            data-price="{{ $val->price }}"
                                                            data-val="{{ $name }}">
                                                            <figure class="PropertiesleftChild">
                                                                <img alt="drawer" width="72" height="72"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="12.58" height="12.58"
                                    ...
                                    <g transform="translate(0.5 0.5)">
                                        <path
                                            ...
                                            transform="translate(-10.395 -10.395)" fill="none" stroke="currentColor"
                        ...
                        <div class="noticeproductdetail">
                            <p>
                                ...
                                2–3 business days for production. After that, your frames will be shipped. Delivery times
                                may vary depending on holidays, weather conditions, or courier delays. As this is a
                                customized product, we kindly ask you to anticipate potential delays. For more accurate
                                delivery estimates, please refer to our Shipping Policy
                            </p>
                        </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="editphotolayoutmodal" tabindex="-1" aria-labelledby="editphotolayoutmodalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="fs-14px fw-semibold cursor-pointer list-group-item" id="swap-image"
                            data-bs-toggle="modal" data-bs-target="#swapphotoslayoutmodal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.875" height="17.169"
                                viewBox="0 0 14.875 17.169" class="w-em h-em me-3">
                                <g transform="translate(-3.25 -1.939)">
                                    <path d="M16,3l3.344,3.344L16,9.688" transform="translate(-1.968)" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5"></path>
                                    <path d="M17.375,7H4" transform="translate(0 -0.656)" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5"></path>
                                    <path d="M7.344,19.688,4,16.344,7.344,13" transform="translate(0 -1.64)"
                                        fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="1.5"></path>
                                    <path d="M4,17H17.375" transform="translate(0 -2.296)" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5"></path>
                                </g>
                            </svg>
                        ...
                        <div class="fs-14px fw-semibold cursor-pointer list-group-item" id="remove-image">
                            <svg width="15.9" height="17.5" class="w-em h-em me-3" viewBox="0 0 15.9 17.5"
                        ...
                        <div class="row SwapImageModal_swapImages">
                            <div class="col-sm-3 col-4">
                                <div class="PlusBtn_plus">
                                    <input class="d-none" accept="image/*" id="upload-photo-modal" multiple
    ...
    <div class="custom-modal swapphotoslayoutmodalparent">
        <div class="modal fade" id="swapphotoslayoutmodal" aria-hidden="true"
            aria-labelledby="swapphotoslayoutmodalToggleLabel2" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.modal').forEach(function(modalEl) {
                modalEl.addEventListener('hidden.bs.modal', function() {
                    ...
                    document.querySelectorAll('.clusterFrameWrp.selected').forEach(function(
                    cluster) {
        ...
        function previewImage(event) {
            ...
            if (files.length > 0) {
                ...
                `;
                            modalPreviewContainer.appendChild(imageDiv);
                            imageDiv.querySelector('.preview-image').addEventListener('click',
                                selectSingleImage);
                ...
                `;
                            modalPreviewContainer2.appendChild(imageDiv2);
                            imageDiv2.querySelector('.preview-image').addEventListener('click',
                                selectSingleImage);
                        });
                    })
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.modal-btns-parent .transparent').addEventListener('click',
            deleteSelectedImage);
        });
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelector(".done-button-2").addEventListener("click", function() {
                if (triggerElement && selectedImageSwapId) {
                    ...
                    let newImageSrc = document.getElementById(`swap-modal-preview-${selectedImageSwapId}`)
                        .src;
        ...
        function updatePrice() {
            ...
            let framePrice = parseFloat(document.querySelector('.select-color .parentProperties.frame-change.active')
                ?.getAttribute('data-price')) || 0;
            let finishPrice = parseFloat(document.querySelector('.select-finish .parentProperties.frame-change.active')
                ?.getAttribute('data-price')) || 0;
            let ledPrice = parseFloat(document.querySelector('.select-led .parentProperties.led-change.active')
                ?.getAttribute('data-price')) || 0;
            let finalPrice = 0;
            if (ledPrice != 0) {
        ...
        document.querySelectorAll('.select-frame .parentProperties.frame-change').forEach(item => {
            item.addEventListener('click', function() {
                ...
                let newFrameClass = this.getAttribute(
                'data-class'); // Use 'data-class' instead of 'data-src'
                let name = this.getAttribute('data-name'); // Use 'data-class' instead of 'data-src'
                let framinners = document.querySelectorAll(
                '.frameinner'); // Note: It's now framinners (plural)
                ...
                document.querySelectorAll('.clusterFrameWrp').forEach(cluster => {
                    cluster.classList.remove('bold-image-width',
                    'box-shadow-dark'); // Remove all possible classes
                    cluster.classList.add(newFrameClass);
                });

                // NEW: Hide colors except the first if frameless is selected
                const colorItems = document.querySelectorAll(
                '.select-color .parentProperties.frame-change');
                if (name === "frameless") {
                    colorItems.forEach((li, index) => {
                        li.style.display = index === 0 ? 'flex' : 'none';
                    });
        ...
        document.querySelectorAll('.select-color .parentProperties.frame-change').forEach(item => {
            item.addEventListener('click', function() {
                ...
                document.querySelectorAll('.select-color .parentProperties.frame-change').forEach(li => li
                    .classList.remove('active'));
                this.classList.add('active');
                ...
                // Update all clusters with the new frame class
                document.querySelectorAll('.clusterFrameWrp').forEach(cluster => {
                    cluster.classList.remove('black-frame', 'dark-frame', 'white-frame',
                        'light-frame'); // Remove all possible classes
                    cluster.classList.add(newFrameClass);
                });
        ...
        document.querySelectorAll('.select-finish .parentProperties.frame-change').forEach(item => {
            item.addEventListener('click', function() {
                document.querySelectorAll('.select-finish .parentProperties.frame-change').forEach(li => li
                    .classList.remove('active'));
                this.classList.add('active');
        ...
        document.querySelectorAll('.select-led .parentProperties.led-change').forEach(item => {
            item.addEventListener('click', function() {
                document.querySelectorAll('.select-led .parentProperties.led-change').forEach(li => li
                    .classList.remove('active'));
                this.classList.add('active');
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire({
                                ...
                                "{{ route('cart') }}"; // Update URL as needed
                            });
                        },
