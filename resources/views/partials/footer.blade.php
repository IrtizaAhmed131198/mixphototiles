    ...
    <div class="text-white text-opacity-35  fs-15 Footer_footerBottomWrp">
        <div class="container">
            <div class="d-flex flex-wrap justify-content-center align-items-center flex-column flex-xl-row gap-3">
                ...
                <div class="d-flex mx-auto me-xl-0 align-items-center flex-wrap text-center justify-content-center flex-column flex-sm-row gap-2">
                    <p class="mb-0">© <!-- -->2025<!-- --> Mixphototiles, Inc. All rights reserved</p><span class="d-none d-sm-block"></span>
